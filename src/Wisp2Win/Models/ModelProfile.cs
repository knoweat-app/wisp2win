    ...
    long ApproxBytes)
{
    ...
    [
        ...
        new("base", "Базовая", "ggml-base.bin", "https://huggingface.co/ggerganov/whisper.cpp/resolve/main/ggml-base.bin", "Faster download, rougher Russian quality", 148L * 1024 * 1024),
        new("small", "Рекомендуемая", "ggml-small.bin", "https://huggingface.co/ggerganov/whisper.cpp/resolve/main/ggml-small.bin", "Better Russian quality, slower download", 488L * 1024 * 1024),
    ...
    public static ModelProfile ById(string id) =>
        All.FirstOrDefault(m => string.Equals(m.Id, id, StringComparison.OrdinalIgnoreCase)) ?? All[2];
}
